  ...
  return (
    <div>
      ...
      <div className="about-card mb-4">
        ...
        <div>
          <p>
            I&rsquo;m a software engineer with a PhD in Physics and over a
            decade of professional experience building web applications. My
            career has taken a winding but intentional path, from studying
            synchronization in chemical oscillator networks to shipping
            production software that serves real people.
          </p>
          <p className="mb-0">
            During grad school at Brandeis, I spent most of my time writing
            simulation code in C and MATLAB. Somewhere along the way I realized
            I liked building the software more than I liked writing the papers.
      ...
      <div className="about-card mb-4">
        ...
        <div>
          ...
          <p className="mb-0">
            ...
            work I got into software engineering to do: building tools that have
            a direct, positive impact on people&rsquo;s lives.
          </p>
        </div>
      </div>
      ...
      <div className="about-card mb-4">
        ...
        <div>
          ...
          <p>
            ...
            leading a small engineering team that built a digital reading
            platform for elementary school literacy programs. Before that, I was
            at Annkissam for six and a half years, growing from a junior Rails
            developer into a senior developer and group manager working across
            nonprofit and healthcare clients.
          </p>
          <p className="mb-0">
            Throughout my career, I&rsquo;ve gravitated toward work that
            matters: edtech, human services, healthcare, civic tech. I like
            knowing the code I write is making someone&rsquo;s day a little
            easier.
          </p>
        </div>
      </div>
      ...
      <div className="about-callout mb-4">
        ...
        <div>
          <h5 className="mt-0 mb-2" style={{ color: 'var(--color-heading)' }}>
            Outside of Work
          </h5>
          <p className="mb-0">
