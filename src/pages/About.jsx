    ...
    <div>
      ...
      <div className="about-card mb-4">
        <div className="about-card-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" aria-hidden="true" viewBox="0 0 16 16">
      ...
      <div className="about-callout mb-4">
        <div className="about-callout-icon">
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" fill="currentColor" aria-hidden="true" viewBox="0 0 16 16">
