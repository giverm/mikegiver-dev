      ...
      <section className="resume-section mb-4">
        ...
        <div className="mb-4">
          <div className="d-flex justify-content-between">
            <strong>Software Engineer &mdash; Nava PBC</strong>
          ...
          <ul className="mt-1">
            ...
            <li>Built end-to-end exemption screener &mdash; a multi-step guided flow with stateless navigation state machine supporting 7 exemption types, enabling Medicaid enrollees to self-determine eligibility without caseworker intervention</li>
        ...
        <div className="mb-4">
          <div className="d-flex justify-content-between">
            <strong>Junior Developer &rarr; Rails Developer &rarr; Senior Developer &amp; Group Manager &mdash; Annkissam, LLC</strong>
