        ...
        <div className="timeline">
            ...
            <div className="timeline-content">
              <div className="d-flex justify-content-between align-items-start flex-wrap">
                <div>
                  ...
                  <span className="text-accent" style={{ fontSize: '0.9rem' }}>Nava PBC</span>
                </div>
                <span className="text-muted small">Sep 2025 &ndash; Present</span>
              </div>
              <ul className="mt-2">
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              <div className="d-flex justify-content-between align-items-start flex-wrap">
                <div>
                  <strong className="d-block">Managing Senior Software Engineer</strong>
                  <span className="text-accent" style={{ fontSize: '0.9rem' }}>Pioneer Valley Books</span>
                </div>
                <span className="text-muted small">Jan 2022 &ndash; Jun 2025</span>
              </div>
              <ul className="mt-2">
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              <div className="d-flex justify-content-between align-items-start flex-wrap">
                ...
                <span className="text-muted small">Dec 2020 &ndash; Dec 2021</span>
              </div>
              <ul className="mt-2">
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              <div className="d-flex justify-content-between align-items-start flex-wrap">
                <div>
                  <strong className="d-block">Junior Developer &rarr; Rails Developer &rarr; Senior Developer &amp; Group Manager</strong>
                  <span className="text-accent" style={{ fontSize: '0.9rem' }}>Annkissam, LLC</span>
                </div>
                <span className="text-muted small">Jun 2014 &ndash; Nov 2020</span>
              </div>
              <ul className="mt-2">
        ...
        <div className="timeline">
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              <div className="d-flex justify-content-between align-items-start flex-wrap">
                <div>
                  <strong className="d-block">Postdoctoral Research Associate</strong>
                  <span className="text-accent" style={{ fontSize: '0.9rem' }}>Iowa State University</span>
                </div>
                <span className="text-muted small">Jun 2013 &ndash; May 2014</span>
              </div>
            </div>
          </div>
          ...
          <div className="timeline-item">
            ...
            <div className="timeline-content">
              <div className="d-flex justify-content-between align-items-start flex-wrap">
                <div>
                  <strong className="d-block">Graduate Research Assistant</strong>
                  <span className="text-accent" style={{ fontSize: '0.9rem' }}>Brandeis University</span>
                </div>
                <span className="text-muted small">Jul 2008 &ndash; Jun 2013</span>
              </div>
              <ul className="mt-2">
